...
function criacao_jogo(body, nivel_n) {
  ...
  var janela_global_largura = window.innerWidth, janela_global_altura = window.innerHeight, janela_jogo = document.createElement('div'), imagem_background, movimentos = 0, i_f_jogo, teclaSolta, teclaPresa;
  // aces
